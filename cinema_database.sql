...
-- билеты на сеанс
insert into ticket (session_id, place_id, price) values (1, 1111, 100);
insert into ticket (session_id, place_id, price) values (1, 1112, 100);
insert into ticket (session_id, place_id, price) values (1, 1113, 100);

insert into ticket (session_id, place_id, price) values (2, 1111, 100);
insert into ticket (session_id, place_id, price) values (2, 1112, 100);
insert into ticket (session_id, place_id, price) values (2, 1113, 100);

insert into ticket (session_id, place_id, price) values (3, 2111, 200);
insert into ticket (session_id, place_id, price) values (3, 2112, 200);

insert into ticket (session_id, place_id, price) values (4, 2111, 200);
insert into ticket (session_id, place_id, price) values (4, 2112, 200);

insert into ticket (session_id, place_id, price) values (5, 3211, 300);
insert into ticket (session_id, place_id, price) values (5, 3212, 300);


-- вычисляем самый прибыльный фильм
select SUM(ticket.price) as sum, movie.movie_name from  ticket
