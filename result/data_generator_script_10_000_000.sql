...
-- plan to 10_000_000
-- 8000 фильмов по 250 значений атрибута из 5 типов //8000х250x5
SET session cinema.number_of_values = '250'; --//кол-во атрибутов одного типа для фильма
SET session cinema.number_of_attributes = '5000';--//общее кол-во атрибутов
SET session cinema.number_of_cinema = '8000';--//общее кол-во фильмов
