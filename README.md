# PHP_2022 Домашнее задание HW10
...
# Залить тестовые данные в Elasticsearch
```
curl -XPOST 'http://mysite.local:9200/_bulk' -H "Content-Type: application/json" --data-binary @books-39289-cdb6ae.json
```
