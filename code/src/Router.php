...
use Nikcrazy37\Hw14\Libs\Exception\Base\FileNotFoundException;
use Nikcrazy37\Hw14\Libs\Exception\BaseException;
use Nikcrazy37\Hw14\Libs\Exception\Base\NotFoundClassException;
use Nikcrazy37\Hw14\Libs\Exception\Base\NotFoundMethodException;
    ...
    public function __construct()
    {
        ...
        foreach ($this->routes as $uriPattern => $path) {
            if (preg_match("~$uriPattern~", $uri)) {
                ...
                $controllerNamespace = "Nikcrazy37\Hw14\Modules\\{$moduleName}\Infrastructure\Controller\\";
