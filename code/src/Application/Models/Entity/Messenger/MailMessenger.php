...
namespace Otus\Mvc\Application\Models\Entity\Messenger;

use Otus\Mvc\Application\Core\App;
use Otus\Mvc\Application\Viewer\View;
use Otus\Mvc\Domain\Models\Interface\MessengerInterface;
use PHPMailer\PHPMailer\PHPMailer;
use Otus\Mvc\Application\Models\Configurators\MailConfigurator;
...
class MailMessenger implements MessengerInterface
{
    public function send(string $email)
    {
        ...
        try {
            ...
            $mail->msgHTML(file_get_contents(__DIR__.'/MailTemplate/Enquiry.html'));
