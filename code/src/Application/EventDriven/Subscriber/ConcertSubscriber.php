...
use Svatel\Code\Application\SendMessage\ConcertMessageGenerator;

final class ConcertSubscriber implements SubscriberInterface
{
    private int $userId;
    ...
    {
        $generator = new ConcertMessageGenerator($event);
