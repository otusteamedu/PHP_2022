...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Цена фильма';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cost` VALUES (1,100,1),(2,150,1),(3,200,1),(4,250,1);
...
CREATE TABLE `currency` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `currency_id_uindex` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `currency` VALUES (1,'Гривня');
