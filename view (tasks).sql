create view "tasks" as		
	...
	left join "attribute_values" av on av."Film_ID" = f."ID" and av."Date" = current_date
	left join "attributes" at2 on at2."ID" = av."Attribute_ID"
	left join "attribute_values" av2 on av2."Film_ID" = f."ID" and av2."Date" = current_date + interval '20 day'
